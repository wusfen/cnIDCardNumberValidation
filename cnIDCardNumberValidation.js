...
console.log(validate('51010119840310628x'))
console.log(validate('110108199611240189'))
console.log(validate('14062319821229451X'))
console.log(validate('411281197408104056'))
console.log(validate('372324196912030043'))
console.log(validate('440902198301240076'))
console.log(validate('431381197606166011    '))
console.log(validate('910207198905061687'))
